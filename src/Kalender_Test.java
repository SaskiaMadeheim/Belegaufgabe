...
public class Kalender_Test {
	...
	public static void main(String[] args) throws IOException 
	{
		...
		Kalender.addEventWoechentlich("Mi.", 2022, "Fuﬂballtraining A Jugend", "Halle 1", "18:00", "19:30");
		Kalender.addEventWoechentlich("Fr.", 2022, "Fuﬂballtraining Kinder", "Halle 2", "14:00", "15:00");
		*/
